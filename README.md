1. The simulation paltform, PlatEMO, is from "https://github.com/BIMK/PlatEMO". (Reference: Ye Tian, Ran Cheng, Xingyi Zhang, and Yaochu Jin, PlatEMO: A MATLAB platform for evolutionary multi-objective optimization [educational forum], IEEE
...
3. To optimize your own customized optimization problem, please first create your own objective functions and constraint functions. Then, you can call these defined functions in PlatEMO's GUI interference to finish problem parameter settings. Next, you can choose corresponding algorithms to solve the target optimization problem with selected algorithms.
